...
<head>
    ...
    <title>@yield('title', 'Melody Shop')</title>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-11">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="img-warp pt-30">
                            <a class="navbar-brand" href="/"> <img src="{{asset('img/logo/logo.jpg')}}" alt="logo"> </a>
                        </div>
                ...
                <div class="col-sm-6 col-lg-2">
                    <div class="single_footer_part">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="{{ url('/categories') }}">Male</a></li>
                            <li><a href="{{ url('/categories') }}">Female</a></li>
                            <li><a href="{{ url('/categories') }}">Shoes</a></li>
                            <li><a href="{{ url('/categories') }}">Fashion</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-2">
